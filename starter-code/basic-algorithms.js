...
let nameUpperCase2 = hacker2
  .toUpperCase()
  .split('')
  .join(' ')
let nameUpperCase = hacker1
  .toUpperCase()
  .split('')
  .join(' ')
...
let reverseName = hacker1
  .split('')
  .reverse()
  .join('')
let reverseName2 = hacker2
  .split('')
  .reverse()
  .join('')
 ...
 */
/*
jdkjnejnknekjjnkejndknjedekjndjdkjnejnknekjjnkejndknjedekjndjdkjnejnknekjjnkejndknjedekjndjdkjnejnknekjjnkejndknjedekjndjdkjnejnknekjjnkejndknjedekjndjdkjnejnknekjjnkejndknjedekjndjdkjnejnknekjjnkejndknjedekjndjdkjnejnknekjjnkejndknjedekjnd */
